"use strict";
function createAutocompleteOverlay(input) {
...
async function requestCompletion(prompt, model) {
    return new Promise((resolve) => {
        chrome.runtime.sendMessage({ action: "getCompletion", prompt, model }, (response) => {
